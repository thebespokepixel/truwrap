...
class Image {
	constructor(_ref) {
		...
		let width = _ref$width === undefined ? 'auto' : _ref$width;
		var _ref$height = _ref.height;
		let height = _ref$height === undefined ? 'auto' : _ref$height;
...
function truwrap(_ref) {
	...
	let left = _ref$left === undefined ? 2 : _ref$left;
	var _ref$right = _ref.right;
	let right = _ref$right === undefined ? 2 : _ref$right,
	    width = _ref.width;
	var _ref$mode = _ref.mode;
	let mode = _ref$mode === undefined ? 'soft' : _ref$mode;
	var _ref$tabWidth = _ref.tabWidth;
	let tabWidth = _ref$tabWidth === undefined ? 4 : _ref$tabWidth;
	var _ref$outStream = _ref.outStream;
	let outStream = _ref$outStream === undefined ? process.stdout : _ref$outStream,
	    tokenRegex = _ref.tokenRegex;
	...
	switch (true) {
		case !ttyActive:
			...
			return Object.assign(Object.create(api), {
				getWidth: () => ttyWidth,
				break() {
					let newlines = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
