...
/*
	...
	Command line help
 */
var _package, clr, console, deepAssign, terminalFeatures, trucolor, truwrap;
...
module.exports = function(yargs_, helpPage_) {
  ...
  header = function() {
    return [clr.title + " " + _package.name + clr.title.out, images.space + " " + _package.description, images.space + " " + clr.grey + (truwrap.getVersion()) + clr.dark].join("\n");
  };
