...
Image = (function() {
  ...
  function Image(source_) {
    var file, name;
    file = source_.file, name = source_.name, this.width = source_.width, this.height = source_.height;
  ...
  Image.prototype.render = function(options_) {
    ...
    align = options_.align, stretch = options_.stretch, nobreak = options_.nobreak;
    if (stretch != null) {
  ...
  Image.prototype.stream = function(wStream, options_) {
    ...
    setBlocking(true);
    wStream.write(this.render(options_));
